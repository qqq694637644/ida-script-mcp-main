...
4. 如果要推进下一项覆盖，优先选择 U010/U011/U014 apply_changes corner cases、read-only endpoint corner cases 或 installer/client config coverage。
