"""Build the U008 /xrefs corner-case guest payload."""
...
PAYLOAD_SCRIPT_NAME = "U008_xrefs_corner_cases.py"
...
def build_guest_u008_xrefs_corner_case_test_script(
    *,
    ...
    """Build a standalone guest script for U008 /xrefs corner-case testing."""
    ...
    if unreplaced:
        raise RuntimeError("Unreplaced U008 /xrefs payload placeholders: " + ", ".join(unreplaced))
    return template
...
def main(argv: list[str] | None = None) -> None:
    ...
    print(f"Wrote U008 /xrefs corner-case guest payload: {output_path}")
