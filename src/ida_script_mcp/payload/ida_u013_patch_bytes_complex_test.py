"""Build the U013 patch_bytes complex-cases guest payload."""
...
PAYLOAD_SCRIPT_NAME = "U013_patch_bytes_complex_cases.py"
...
def build_guest_u013_patch_bytes_complex_test_script(
    *,
    ...
    """Build a standalone guest script for U013 patch_bytes complex cases."""
    ...
    if unreplaced:
        raise RuntimeError("Unreplaced U013 payload placeholders: " + ", ".join(unreplaced))
    return template
...
def main(argv: list[str] | None = None) -> None:
    ...
    print(f"Wrote U013 patch_bytes complex-cases guest payload: {output_path}")
