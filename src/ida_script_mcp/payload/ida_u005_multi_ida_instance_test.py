"""Build the U005 multi-IDA instance selection guest payload."""
...
PAYLOAD_SCRIPT_NAME = "U005_multi_IDA_instance_selection.py"
...
def build_guest_u005_multi_ida_instance_test_script(
    *,
    ...
    """Build a standalone guest script for U005 multi-IDA instance testing."""
    ...
    if unreplaced:
        raise RuntimeError("Unreplaced U005 payload placeholders: " + ", ".join(unreplaced))
    return template
...
def main(argv: list[str] | None = None) -> None:
    ...
    print(f"Wrote U005 multi-IDA instance guest payload: {output_path}")
