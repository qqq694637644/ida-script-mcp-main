...
核心 V2.3 worker 生命周期测试 U001-U003、真实 MCP client smoke U004、多 IDA 实例选择 U005、以及 `/decompile` corner case U007 已全部通过并移入 `TESTED.md`：
...
下一轮建议从 U006 `/functions`、U008 `/xrefs`、U009 `/inspect_address`，或 apply_changes / installer / client config coverage 开始。
